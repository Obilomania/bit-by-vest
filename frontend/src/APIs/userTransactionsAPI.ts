...
export const { useCreateNewDepositMutation, useGetUserLastDepositAmountQuery, useGetUserPendingDepositAmountQuery, useGetUserTotalDepositAmountQuery, useGetUserAccountBalanceQuery, useGetUserLastWithdrawAmountQuery, useGetUserPendingWithdrawAmountQuery, useGetUserWithdrawTotalAmountQuery, useGetAllUserWithdrawalsQuery,useGetallUserDepositQuery,useCreateNewWithdrawalMutation, } = userTransactionAPI;
